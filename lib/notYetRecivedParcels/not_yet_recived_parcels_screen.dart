...
class NotYetRecivedParcelsScreen extends StatefulWidget {
  const NotYetRecivedParcelsScreen({Key? key}) : super(key: key);

  @override
  State<NotYetRecivedParcelsScreen> createState() => _NotYetRecivedParcelsScreenState();
}

class _NotYetRecivedParcelsScreenState extends State<NotYetRecivedParcelsScreen> {
  @override
