...
class _SearchScreenState extends State<SearchScreen> {
  ...
  initilizeSearchingStores(String textEnteredByUser) async {
    storesDocumentsList = FirebaseFirestore.instance
        .collection('sellers')
        //query -> prikazace top sellers koji su jednaki unosu
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: TextField(
          onChanged: (textEnterred) {
            setState(() {
              sellerNameText = textEnterred;
            });
            initilizeSearchingStores(sellerNameText);
          },
